...
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { cs }]; #IO_L6P_T0_15 Sch=ja[4]
# set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { ssd_aa }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
# set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { ssd_ab }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
# set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { ssd_ac }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
# set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { ssd_ad }]; #IO_25_15 Sch=ja[10]
...
# set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { ssd_ae }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
# set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { ssd_af }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
# set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { ssd_ag }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
# set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { ssd_cat }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]
...
set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { ck_rstn }]; #IO_L16P_T2_35 Sch=ck_rst
