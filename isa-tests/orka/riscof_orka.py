...
class orka(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","orka")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for orka start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            # set up the simulation command. Template is for orka. Please change.
